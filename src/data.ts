...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Cloud Deployment (Vercel/Render)", level: 80, iconName: "Cloud" }
    ]
  }
];
...
export const PROJECTS: Project[] = [
  {
    ...
    description: "A highly interactive responsive admin dashboard built with React.js. Features sophisticated custom-made UI views, analytics widgets, real-time-looking data visualization graphs, dynamic tables, and highly refined structural grid configurations.",
    technologies: ["React.js", "JavaScript (ES6)", "Tailwind CSS", "Recharts", "Framer Motion"],
  ...
  },
  {
    ...
    description: "A frontend e-commerce storefront system designed and coded for a high-intensity hackathon. Includes structured product browsing, checkout simulation layouts, fluid visual shopping bag feedback, and precise design values.",
    technologies: ["HTML5", "CSS3", "JavaScript", "Responsive Design", "Flexbox/Grid"],
    githubUrl: "https://github.com/matiurrehmanmarwatkhan/Mati-Ur-Rehman-Hackathon-Project",
    liveUrl: "https://matiurrehmanmarwatkhan.github.io/Mati-Ur-Rehman-Hackathon-Project/",
    category: "Frontend"
  },
  {
    id: "proj-3",
    title: "Todo App with CRUD Operations",
    description: "A clean, functional task manager implementing complete Create, Read, Update, and Delete actions with seamless vanilla JS DOM event bindings, state filtering (all/completed/pending), and direct task status toggles.",
...
export const EDUCATION: TimelineEntry[] = [
  {
    ...
    period: "2025 – Present",
    description: "Rigorous full-stack training covering advanced JavaScript concepts, responsive modern frontend engineering with React, complex server development using Node.js and Express, database architecture utilizing MongoDB with Mongoose, and industry standard deployment pipelines under mentorship."
  },
  {
    id: "edu-2",
    ...
    period: "2023 – 2025",
    description: "Academic foundation in fundamental computer systems, programming methodologies, databases basics, algorithm constructs, and scientific mathematics. Explored initial coding practices that sparked the passion for developer studies."
  }
];
